...
function ContactForm() {
  ...
  const reset = () => {
    formData.name = ''
    formData.email = ''
    formData.interest = 'Custom Software Development'
    formData.message = ''
  }
  ...
  const handleSubmit = async (e: any) => {
    ...
    fetch('https://formsubmit.co/ajax/habblanka@gmail.com', {
      method: 'POST',
                ...
                <div className='flex flex-col md:flex md:flex-row gap-6'>
                  <div className='w-full'>
                    ...
                    <div className='relative'>
                      <select
                        className='w-full appearance-none text-base px-5 py-3 rounded-full border transition-all duration-300 dark:border-white/20 focus:outline-none focus:border-purple dark:focus:border-purple dark:bg-black/40 bg-white cursor-pointer pr-12'
                        name='interest'
                        id='interest'
                        ...
                        <option value='SaaS & Custom Solutions'>SaaS & Custom Solutions</option>
                      </select>
                      <div className='absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none'>
                        <svg
                          className='w-5 h-5 text-dark_black/60 dark:text-white/60'
                          fill='none'
                          stroke='currentColor'
                          viewBox='0 0 24 24'
                        >
